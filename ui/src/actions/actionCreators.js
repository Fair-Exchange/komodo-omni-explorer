...
export function getInterest(address, currentState) {
  return dispatch => {
    return fetch(`http://${config.ip}:${config.port}/api/safe/interest?address=${address}`, {
      method: 'GET',
    })
    .catch((error) => {
      console.warn(error);
...
export function getUnspents(address, currentState) {
  return dispatch => {
    return fetch(`http://${config.ip}:${config.port}/api/safe/listunspent?address=${address}`, {
      method: 'GET',
    })
    .catch((error) => {
      console.warn(error);
...
export function fiatRates() {
  return dispatch => {
    return fetch(`http://${config.ip}:${config.port}/api/rates/safe`, {
      method: 'GET',
    })
    .catch((error) => {
      console.warn(error);
