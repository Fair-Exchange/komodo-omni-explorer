        ...
        <div className="container-fluid">
          <div className="row text-center">
            ...
            <div className="col-md-2 col-sm-12">
              <img
                src={ `http://${config.ip}:${config.port}/public/images/safe-logo.png` }
                alt="Safecoin logo"
                height="100px" />
            </div>
              ...
              <div className="form-inline">
                <div
                  ...
                  <input
                    ...
                    placeholder={ this.props.path === '/interest' ? 'Enter a valid SAFE address' : 'You may enter a tx hash or an address.' }
        ...
        <footer className="site-footer hidden-xs">
          <div className="row">
            <div className="col-md-12">
              <a
                href="https://twitter.com/SafecoinPlatform"
                target="_blank">
